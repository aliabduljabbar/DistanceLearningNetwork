...
#define BAR_SEL_COLOR eride_color //[UIColor colorWithRed:76.0f/255.0f green:172.0f/255.0f blue:239.0f/255.0f alpha:0.8]
...
- (void)buildControl {
    ...
    [_saveButton setTitle:@"Choose this Date and Time" forState:UIControlStateNormal];
